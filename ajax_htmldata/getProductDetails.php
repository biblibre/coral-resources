...
<?php
      ...
      if(count($resource->getChildResources())>0){ //resource is a package with children ?>  <a  href='ajax_processing.php?action=customImportedPackageContent&height=503&width=775&modal=true&id=<?php echo $resourceID; ?> id='custom' class='thickbox'><img src='images/repo.gif' alt='Customize package content' title='custom'></a> <?php  } ?>
      <a href='ajax_forms.php?action=getUpdateProductForm&height=498&width=730&resourceID=<?php echo $resource->resourceID; ?>&modal=true' class='thickbox'><img src='images/edit.gif' alt='<?php echo _("edit");?>' title='<?php echo _("edit resource");?>'></a><?php } ?>  <?php if ($user->isAdmin){ ?><a href='javascript:void(0);' class='removeResource' id='<?php echo $resourceID; ?>'><img src='images/cross.gif' alt='<?php echo _("remove resource");?>' title='<?php echo _("remove resource");?>'></a> <a href='javascript:void(0);' class='removeResourceAndChildren' id='<?php echo $resourceID; ?>'><img src='images/deleteall.png' alt='<?php echo _("remove resource and its children");?>' title='<?php echo _("remove resource and its children");?>'></a><?php } ?></span>
